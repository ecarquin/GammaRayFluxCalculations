...
void MakePlots()
{
   ...
   TFile *f=TFile::Open("outputs/AEMuNue_3500.root","READ");
   ...
   tname << "outputs/dnde_gamma_" << "AEMuNue" << "_" << 3500 << ".txt";
   ...
   tname << "outputs/dnde_elect_" << "AEMuNue" << "_" << 3500 << ".txt";
   ...
   tname << "outputs/dnde_posit_" << "AEMuNue" << "_" << 3500 << ".txt";
   ...
   tname << "outputs/dnde_antip_" << "AEMuNue" << "_" << 3500 << ".txt";
